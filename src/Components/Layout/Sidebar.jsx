				...
				{estaAbierto && (
					<motion.div
						...
						<ContenidoBarraLateral
							...
							onPecharSesion={() => dispatch(pecharSesion())}
	...
	return (
		<div className='space-y-8 w-fit'>
			<div className='text-center border-b border-gray-200 dark:border-gray-700 pb-6'>
				...
				<p className='mt-3 text-sm font-medium text-gray-700 dark:text-gray-200'>{usuarioActual?.nome || usuarioActualId}</p>
				<div className='mt-2 flex items-center justify-center gap-2'>
					...
					<button
						...
						className='shrink-0 p-1 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-red-500 transition-colors'
						aria-label={t.logout}
						title={t.logout}>
