...
```text
xertor-de-tarefas-app/
├── android/                    # Proxecto nativo Android (Capacitor)
├── public/
│   └── Images/                 # Banner, logo e GIF da interface
├── src/
│   ├── App/                    # Núcleo da app
│   │   ├── store.js            # Store Redux (tareas, tema, idioma, usuarios, proxectos, notas)
│   │   ├── firebase.js         # Inicialización de Firebase/Firestore dende .env
│   │   └── persistence.js      # Cargar/gardar/subscribirse ao documento compartido
│   ├── Components/             # UI por áreas
│   │   ├── Auth/               # LoginView
│   │   ├── Calendar/           # CalendarView + ErrorBoundary
│   │   ├── Layout/             # Header, Sidebar, UserSettingsView
│   │   ├── Notes/              # NotesView
│   │   ├── Options/            # Opcións globais e xestión de usuarios
│   │   ├── Projects/           # ProjectsView (proxectos + cliente + KDBX)
│   │   ├── Tasks/              # TasksList, TaskItem, TaskForm, TaskFilter
│   │   └── UI/                 # DarkMode, ToastCenter
...
│   ├── Assets/                 # Fontes SF Pro e FontAwesome
│   ├── Styles/
│   │   └── DarkMode.css        # Estilos do tema escuro
│   ├── Utils/
│   │   └── toast.js            # Helper de notificacións
│   ├── App.jsx                 # Composición de vistas e navegación
│   ├── main.jsx                # Punto de entrada (Provider + carga inicial)
...
├── eslint.config.js
├── .env / .env.example         # Credenciais de Firebase (VITE_FIREBASE_*)
└── package.json                # Scripts: dev, build, lint, android:sync/open/run
```
